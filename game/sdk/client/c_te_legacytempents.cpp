...
void CTempEnts::EjectBrass( const Vector &pos1, const QAngle &angles, const QAngle &gunAngles, int type )
{
	...
	if ( type > 3 )
	{
		// Don't give magazines any angular velocity
		pTemp->m_vecTempEntAngVelocity[0] = pTemp->m_vecTempEntAngVelocity[1] = pTemp->m_vecTempEntAngVelocity[2] = 0;
	}
	else
	{
	...
	if ( type > 3 )
	{
		pTemp->SetVelocity( Vector(dir[0], dir[1], dir[2] + random->RandomFloat(0,10) ) );
	}
	else
	{
