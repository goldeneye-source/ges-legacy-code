...
void CNPC_Antlion::HandleAnimEvent( animevent_t *pEvent )
{
	...
	{
		QAngle a( 20.0f, 0.0f, -12.0f );
		Vector v( -250.0f, 1.0f, 1.0f );
		MeleeAttack( ANTLION_MELEE1_RANGE, sk_antlion_swipe_damage.GetFloat(), a, v);
		return;
	}
