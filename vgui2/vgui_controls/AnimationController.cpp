...
class AutoDelAniController
{
public: 
	AutoDelAniController()
	{
		s_pAnimationController = NULL;
	}

	~AutoDelAniController()
	{
		//memory leaks here but causes a crash on exit. Lodle
		//if (s_pAnimationController)
		//{
		//	delete s_pAnimationController;
		//	s_pAnimationController = NULL;
		//}
	}

	AnimationController *s_pAnimationController;
};

AutoDelAniController adac;


AnimationController *GetAnimationController()
{
	if (!adac.s_pAnimationController)
		adac.s_pAnimationController = new AnimationController(NULL);

	return adac.s_pAnimationController;
}
