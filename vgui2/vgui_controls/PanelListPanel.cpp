...
void PanelListPanel::PerformLayout()
{
	...
	m_pPanelEmbedded->SetSize( wide - sbWidth - 2, vpixels );
	...
	int iColumnWidth = ( wide - xpos - sbWidth - 12 ) / m_iNumColumns;
